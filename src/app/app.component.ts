...
export class AppComponent { formularioDeContacto: FormGroup | any;
  ...
  alEnviarMensaje() {
    ...
    if (this.formularioDeContacto.valid == true) { window.open('https://wa.me/' + 2214950401 + '?text=Hola, mi nombre es '
